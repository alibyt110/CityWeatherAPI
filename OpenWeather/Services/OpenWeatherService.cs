...
public sealed class OpenWeatherService : IOpenWeatherService
{
    ...
    public async Task<ServiceResult<WeatherDataDto?>> GetWeather(string city)
    {
        ...
        if (cityLocation == null)
        {
            ...
            return ServiceResult<WeatherDataDto>.Fail("City location could not be determined.");
        }
        ...
        if (weather == null)
        {
            ...
            return ServiceResult<WeatherDataDto>.Fail("Weather data could not be retrieved.");
        }
        ...
        if (airPollution == null)
        {
            ...
            return ServiceResult<WeatherDataDto>.Fail("Air pollution data could not be retrieved.");
        }

        var weatherData = MapToWeatherDataDto(cityLocation, weather, airPollution);

        return ServiceResult<WeatherDataDto>.Ok(weatherData);
    }
